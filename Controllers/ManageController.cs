...
using DarInternet.Identity.Models.ManageViewModels;
using DarInternet.Identity.Models;
using DarInternet.Identity.Services;
using Microsoft.Extensions.Localization;
using DarInternet.Identity.Resources;
using System.Reflection;
using System.Collections.Generic;
using Newtonsoft.Json;
using Microsoft.AspNetCore.WebUtilities;

namespace DarInternet.Identity.Controllers
{
    [Authorize]
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            await _emailSender.SendEmail(
               model.Email,
               "DarInternet.Identity Verification Email",
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("DarInternet.Identity"),
